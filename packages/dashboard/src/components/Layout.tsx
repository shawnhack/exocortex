...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v20" /><path d="M2 12h4" /><path d="M18 12h4" /><path d="M4.93 4.93l2.83 2.83" /><path d="M16.24 16.24l2.83 2.83" />
      </svg>
    ),
  },
  {
  ...
  if (isMobile) {
    return (
      <div style={{ display: "flex", minHeight: "100vh", position: "relative" }}>
        ...
        {/* Backdrop */}
        {mobileOpen && (
          <div className="mobile-backdrop" onClick={() => setMobileOpen(false)} role="presentation" />
        )}
